...
## Часть первая - Цель, область применения, определения и запрет на высылку
## Раздел первый - Цель, область применения и определения
## Статья 1 - Цель
### 1
...
## Часть вторая - Иностранцы
## Раздел первый - Въезд в Турцию и визы
...
Если заинтересованное лицо не представлено адвокатом, оно само или его законный представитель информируется о результате решения, процедурах и сроках обжалования.
## ЧАСТЬ ЧЕТВЕРТАЯ
## Общие положения об иностранцах и международной защите
